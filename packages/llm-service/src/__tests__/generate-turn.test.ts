...
vi.mock('ai', function() { return { generateObject: mockGenerateObject }; });

vi.mock('@ai-sdk/anthropic', function() { return { anthropic: mockAnthropic }; });
  ...
  it('should call generateObject with Anthropic model and Zod schema', async () => {
    const mockResponse: LLMGameResponse = {
      ...
      suggested_action_buttons: [
        { button_label: 'Go to Corridor', action_id: 'action-move-to-corridor-a' },
      ],
    };
